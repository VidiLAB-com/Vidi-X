...
//-- uz dodatak zapisivanja statusa temperature i releya u realnom ---
//-- vremenu na SD karticu, ------------------------------------------
//-- napisan za potrebe članka u časopisu VIDI 323 - veljača 2023. ---
//--------------------------------------------------------------------
//
...
//
//-------------------------------------------------------------------
// napisao: Hrvoje Šomođi, Vidi - 18.01.2023. - verzija 0.03
//-------------------------------------------------------------------
//
...
#include <SPI.h>
#include "C:\Users\Podrska\Documents\SD kartica VIDI X-a\Temperature_v3\SD_Card_Data_Log.h"
...
void SD_Card_Data_Log() {
  // make a string for assembling the data to log:
  String dataString = "DeltaMin = ";
  dataString += valMin; //
  dataString += " DeltaMax = ";
  dataString += valMax; //
  dataString += " Temp = ";
  dataString += val; //
  dataString += " CiljanaTemp = ";
  dataString += ciljTemp;
  dataString += " TempC1 = ";
  dataString += tempC1;
  dataString += " var. = ";
